...
//@Configuration
@ComponentScan(basePackages={"com.wangxs"})
@Import(JdbcConfig.class)
@PropertySource("classpath:jdbcConfig.properties") //classpath 表名后面的路径是类路径
...
public class SpringConfiguration {
     ...
     * @return
     */
    @Bean(name = "runner")//此注解用于把当前方法的返回值作为bean对象存入sring的ioc容器中
//    @Scope("prototype")
